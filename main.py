...
SUPPORTED_PLATFORMS = {
        'pico': pico.setup,
        'esp32': esp32_idf.setup # esp32 is considered as esp-idf
        }
...
def main():
    ...
    _ = parser.add_argument('platform', choices=SUPPORTED_PLATFORMS.keys(), help='The target platform to set up (e.g., pico, esp32).')
